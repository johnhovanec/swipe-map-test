    ...
    1: [
      function (h, u, e) {
        (function (e) {
          ...
          function o() {
            ((r = this._map.dragging.enabled()),
              (t = this._map.tap && this._map.tap.enabled()),
              this._map.dragging.disable(),
              this._map.tap && this._map.tap.disable());
          }
          function d(e) {
            (this._refocusOnMap(e),
              r && this._map.dragging.enable(),
              t && this._map.tap.enable());
          }
          function l(e) {
          ...
          (h("./layout.css"),
            ...
            (i.Control.SideBySide = i.Control.extend({
              ...
              addTo: function (e) {
                ...
                var r = (this._container = i.DomUtil.create(
                  "div",
                  "leaflet-sbs",
                  e._controlContainer,
                ));
                this._divider = i.DomUtil.create(
                  "div",
                  "leaflet-sbs-divider",
                  r,
                );
                var t = (this._range = i.DomUtil.create(
                  "input",
                  "leaflet-sbs-range",
                  r,
                ));
                return (
                  ...
                  i.DomEvent.disableScrollPropagation &&
                    i.DomEvent.disableScrollPropagation(t),
                  n(t, "mousedown", i.DomEvent.stopPropagation, this),
                  n(t, "touchstart", i.DomEvent.stopPropagation, this),
                  this._addEvents(),
                  this._updateLayers(),
                  this
                );
              ...
              remove: function () {
                return (
                  this._map &&
                    ...
                    this._removeEvents(),
                    i.DomUtil.remove(this._container),
                    (this._map = null)),
                  this
                );
              },
              ...
              _updateClip: function () {
                var e = this._map,
                  ...
                  i = this.getPosition();
                ((this._divider.style.left = i + "px"),
                  this.fire("dividermove", { x: i }));
                var a = "rect(" + [r.y, n, t.y, r.x].join("px,") + "px)",
                  s = "rect(" + [r.y, t.x, t.y, n].join("px,") + "px)";
                (this._leftLayer &&
                  (this._leftLayer.getContainer().style.clip = a),
                  this._rightLayer &&
                    (this._rightLayer.getContainer().style.clip = s));
              },
              _updateLayers: function () {
                ...
                ((this._leftLayer = this._rightLayer = null),
                  ...
                  e !== this._leftLayer &&
                    (e && this.fire("leftlayerremove", { layer: e }),
                    this._leftLayer &&
                      this.fire("leftlayeradd", { layer: this._leftLayer })),
                  r !== this._rightLayer &&
                    (r && this.fire("rightlayerremove", { layer: r }),
                    this._rightLayer &&
              ...
              _addEvents: function () {
                ...
                r &&
                  e &&
                  (r.on("move", this._updateClip, this),
                  r.on("layeradd layerremove", this._updateLayers, this),
                  n(e, "input change", this._updateClip, this),
                  n(e, i.Browser.touch ? "touchstart" : "mousedown", o, this),
                  n(e, i.Browser.touch ? "touchend" : "mouseup", d, this));
              },
              _removeEvents: function () {
                var e = this._range,
                  r = this._map;
                (e &&
                  (a(e, "input change", this._updateClip, this),
                  a(e, i.Browser.touch ? "touchstart" : "mousedown", o, this),
                  a(e, i.Browser.touch ? "touchend" : "mouseup", d, this)),
                  r &&
                    (r.off("layeradd layerremove", this._updateLayers, this),
                    r.off("move", this._updateClip, this)));
              },
            })),
        ...
        ((r.exports = function (r, e, t) {
          ...
          (r.exports.byUrl = function (e) {
            if (document.createStyleSheet)
              return document.createStyleSheet(e).ownerNode;
